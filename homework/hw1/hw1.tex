...
Modify the code \texttt{expx.c} to compute a better-balanced $N$ term Taylor Polynomial approximation
...
\item The answer should be printed out from process 0 only, and should include both the solution and the relative error
